...
#         steps (Optional[Union[List[str], str]]): ordered names of SimpleManuscript
...
#         Args:
#             outline (Option): settings for parameters to be built.
...
#     def make_runtime(self, outline: 'Option') -> None:
...
#         algorithm: str,
#         **kwargs) -> 'Option':
#     outline = Option(name = name, module = module, algorithm = algorithm)
