...
class Divider(Tool):
    ...
    def include(self, divider_name, new_divider):
        if not hasattr(divider_name):
            setattr(self, divider_name, new_divider)
        self.options.update({divider_name, new_divider})
        return self
