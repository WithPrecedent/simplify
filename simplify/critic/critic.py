...
and data analysis portions of the siMpLify package. It contains the Critic
...
class Critic(SimpleClass):
    ...
    analysis from the siMpLify Almanac and Cookbook.
    ...
    def _define(self):
        """Sets default options for the Critic review."""
